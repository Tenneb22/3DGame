...
public class ShaderManager {
    ...
    public void createVertexShader(String shaderCoder) throws Exception {
        vertexShaderID = createShader(shaderCoder, GL20.GL_VERTEX_SHADER);
    }

    public void createFragmentShader(String shaderCoder) throws Exception {
        fragmentShaderID = createShader(shaderCoder, GL20.GL_FRAGMENT_SHADER);
    }
